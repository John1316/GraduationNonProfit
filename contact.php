...
if (isset($_POST['csubmit']))
{
    ...
    if ((empty($name))){
        $empty = "Please check this fields and fill it again it's important for us";
    }
    ...
    {
        $ins= "INSERT INTO newprod (cust_name,cust_phone,name,quantity,cust_location,cust_desc,image,expdate) VALUES('$cname','$phone','$name','$quantity','$location','$des','$addedPhoto','$expdate')";
