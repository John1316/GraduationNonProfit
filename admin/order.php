...
if (isset($_POST['submit'])) {
            ...
            $ins= "INSERT INTO accorders (order_id,cust_name,name,cust_phone,cust_add,delivery_time,quan,code) VALUES('$id','$uname','$name','$phone','$address','$datetime','$quan','$code')";
...
<body id="reportsPage">
    <div class="" id="home">
        ...
        <section class="all py-5 container">
                    ...
                    <?php if(isset($deleted)): ?>
                        <div class="alert alert-danger text-uppercase container w-75 alert-dismissible fade show" role="alert">
                            <h4><?= $deleted ?></h5>
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
    ...
    <div class="modal-dialog" role="document">
        <form action="order.php" class="tm-edit-product-form" method="POST">
            <div class="modal-content text-white">
                ...
                <div class="modal-body">
                    <h6>Do you want to Reject Order <input type="hidden" name="oid" value="<?php echo $result ['order_id']; ?>"> <span class="badge badge-warning"> <?php echo $result ['order_id']; ?></span> and for Customer Name : <span class="badge badge-warning mx-2"><?php echo $result ['cust_name']; ?></span></h6>
                </div>
