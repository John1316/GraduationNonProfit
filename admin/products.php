...
$ins= "INSERT INTO tblproduct (name,des,code,quantites,image,expdate) VALUES('$name','$des','$code','$quantites','product-images/$profileImageName','$expdate')"; 
...
$up= "UPDATE tblproduct SET name='$name' , des='$des', code='$code' , quantites='$upquan', image='product-images/$profileImageName' , expdate='$expdate' WHERE id='$id'"; 
    ...
    <div class="container mt-5">
        <div class="row tm-content-row">
            <div class="col-sm-12 col-md-12 tm-block-col">
                ...
                <button type="button" data-toggle="modal" <?php echo $disable ?> data-target="#add" class="btn mb-3 px-4 py-2 text-white btn-primary rounded"><i class="fas mr-2 fa-plus"></i>Add product</button>
                        ...
                        <table class="table table-hover tm-table-small tm-product-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $result ['quantites']; ?></td>
                  ...
                  <div class="container-fluid">
                    <form action="products.php" method="post" enctype="multipart/form-data">
                        <div class="row text-white">
                            ...
                            <div class="col-6 my-2"> <label for="name">Product Quantites</label><input name="upquan" type="number" value="<?php echo $result ['code']; ?>" class="form-control validate" required /></div>
                  ...
                  <div class="container-fluid">
                    <form action="products.php" method="post" enctype="multipart/form-data">
                        <div class="row text-white">
                            ...
                            <div class="col-6 my-2"> <label for="name">Product Quantites</label><input name="quan" type="number" class="form-control validate" required /></div>
                            <div class="col-6 my-2"> <label for="name">Product IMAGE</label><input name="img" type="file" class="form-control validate" required /></div>
